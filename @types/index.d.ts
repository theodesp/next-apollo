...
export declare type ValueTypes = {
    ...
    ["RootQuery"]: AliasType<{
        ...
        badges?: [
            {
                ...
                where?: ValueTypes["RootQueryToBadgeConnectionWhereArgs"] | null;
            },
            ValueTypes["RootQueryToBadgeConnection"]
        ];
        categories?: [
            {
                first?: number | null; /** The number of items to return before the referenced "before" cursor */
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["RootQueryToCategoryConnectionWhereArgs"] | null;
            },
            ValueTypes["RootQueryToCategoryConnection"]
        ];
        category?: [
            {
                id: string; /** Type of unique identifier to fetch by. Default is Global ID */
                idType?: ValueTypes["CategoryIdType"] | null;
            },
            ValueTypes["Category"]
        ];
        comment?: [
        ...
        comments?: [
            {
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["RootQueryToCommentConnectionWhereArgs"] | null;
            },
            ValueTypes["RootQueryToCommentConnection"]
        ];
        contentNode?: [
            {
        ...
        contentNodes?: [
            {
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["RootQueryToContentNodeConnectionWhereArgs"] | null;
            },
            ValueTypes["RootQueryToContentNodeConnection"]
        ];
        contentType?: [
            {
                id: string; /** Type of unique identifier to fetch a content type by. Default is Global ID */
                idType?: ValueTypes["ContentTypeIdTypeEnum"] | null;
            },
            ValueTypes["ContentType"]
        ];
        contentTypes?: [
            {
                first?: number | null; /** The number of items to return before the referenced "before" cursor */
            ...
            ValueTypes["RootQueryToContentTypeConnection"]
        ];
        ...
        heroes?: [
            {
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["RootQueryToHeroConnectionWhereArgs"] | null;
            },
            ValueTypes["RootQueryToHeroConnection"]
        ];
        mediaItem?: [
            {
                id: string; /** Type of unique identifier to fetch by. Default is Global ID */
        ...
        mediaItems?: [
            {
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["RootQueryToMediaItemConnectionWhereArgs"] | null;
            },
            ValueTypes["RootQueryToMediaItemConnection"]
        ];
        menu?: [
            {
                id: string; /** Type of unique identifier to fetch a menu by. Default is Global ID */
                idType?: ValueTypes["MenuNodeIdTypeEnum"] | null;
            },
            ValueTypes["Menu"]
        ];
        menuItem?: [
            {
                ...
                idType?: ValueTypes["MenuItemNodeIdTypeEnum"] | null;
            },
            ValueTypes["MenuItem"]
        ];
        menuItems?: [
            {
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["RootQueryToMenuItemConnectionWhereArgs"] | null;
            },
            ValueTypes["RootQueryToMenuItemConnection"]
        ];
        menus?: [
            {
                first?: number | null; /** The number of items to return before the referenced "before" cursor */
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["RootQueryToMenuConnectionWhereArgs"] | null;
            },
            ValueTypes["RootQueryToMenuConnection"]
        ];
        movie?: [
            {
                id: string; /** Type of unique identifier to fetch by. Default is Global ID */
        ...
        movies?: [
            {
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["RootQueryToMovieConnectionWhereArgs"] | null;
            },
            ValueTypes["RootQueryToMovieConnection"]
        ];
        node?: [
            {
                id?: string | null;
        ...
        nodeByUri?: [
            ...
            ValueTypes["UniformResourceIdentifiable"]
        ];
        page?: [
            {
                id: string; /** Type of unique identifier to fetch by. Default is Global ID */
        ...
        pages?: [
            {
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["RootQueryToPageConnectionWhereArgs"] | null;
            },
            ValueTypes["RootQueryToPageConnection"]
        ];
        plugin?: [
            {
                id: string;
        ...
        plugins?: [
            ...
            ValueTypes["RootQueryToPluginConnection"]
        ];
        post?: [
            {
                id: string; /** Type of unique identifier to fetch by. Default is Global ID */
        ...
        postFormat?: [
            {
                id: string; /** Type of unique identifier to fetch by. Default is Global ID */
                idType?: ValueTypes["PostFormatIdType"] | null;
            },
            ValueTypes["PostFormat"]
        ];
        postFormats?: [
            {
                first?: number | null; /** The number of items to return before the referenced "before" cursor */
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["RootQueryToPostFormatConnectionWhereArgs"] | null;
            },
            ValueTypes["RootQueryToPostFormatConnection"]
        ];
        posts?: [
            {
                first?: number | null; /** The number of items to return before the referenced "before" cursor */
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["RootQueryToPostConnectionWhereArgs"] | null;
            },
            ValueTypes["RootQueryToPostConnection"]
        ];
        ...
        registeredScripts?: [
            ...
            ValueTypes["RootQueryToEnqueuedScriptConnection"]
        ];
        registeredStylesheets?: [
            ...
            ValueTypes["RootQueryToEnqueuedStylesheetConnection"]
        ];
        revisions?: [
            {
                first?: number | null; /** The number of items to return before the referenced "before" cursor */
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["RootQueryToContentRevisionUnionConnectionWhereArgs"] | null;
            },
            ValueTypes["RootQueryToContentRevisionUnionConnection"]
        ];
        tag?: [
            {
                id: string; /** Type of unique identifier to fetch by. Default is Global ID */
                idType?: ValueTypes["TagIdType"] | null;
            },
            ValueTypes["Tag"]
        ];
        tags?: [
            {
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["RootQueryToTagConnectionWhereArgs"] | null;
            },
            ValueTypes["RootQueryToTagConnection"]
        ];
        taxonomies?: [
            {
                first?: number | null; /** The number of items to return before the referenced "before" cursor */
            ...
            ValueTypes["RootQueryToTaxonomyConnection"]
        ];
        taxonomy?: [
            {
                id: string; /** Type of unique identifier to fetch a taxonomy by. Default is Global ID */
                idType?: ValueTypes["TaxonomyIdTypeEnum"] | null;
            },
            ValueTypes["Taxonomy"]
        ];
        termNode?: [
            {
                ...
                taxonomy?: ValueTypes["TaxonomyEnum"] | null;
            },
            ValueTypes["TermNode"]
        ];
        terms?: [
            {
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["RootQueryToTermNodeConnectionWhereArgs"] | null;
            },
            ValueTypes["RootQueryToTermNodeConnection"]
        ];
        theme?: [
            {
                id: string;
        ...
        themes?: [
            ...
            ValueTypes["RootQueryToThemeConnection"]
        ];
        user?: [
            {
                id: string; /** Type of unique identifier to fetch a user by. Default is Global ID */
                idType?: ValueTypes["UserNodeIdTypeEnum"] | null;
            },
            ValueTypes["User"]
        ];
        userRole?: [
        ...
        userRoles?: [
            ...
            ValueTypes["RootQueryToUserRoleConnection"]
        ];
        users?: [
            {
                first?: number | null; /** The number of items to return before the referenced "before" cursor */
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["RootQueryToUserConnectionWhereArgs"] | null;
            },
            ValueTypes["RootQueryToUserConnection"]
        ];
    ...
    ["Badge"]: AliasType<{
        ...
        enqueuedScripts?: [
            ...
            ValueTypes["ContentNodeToEnqueuedScriptConnection"]
        ];
        enqueuedStylesheets?: [
            {
                first?: number | null; /** The number of items to return before the referenced "before" cursor */
            ...
            ValueTypes["ContentNodeToEnqueuedStylesheetConnection"]
        ];
        ...
        heroes?: [
            ...
            ValueTypes["BadgeToHeroConnection"]
        ];
        ...
        title?: [
            {
                format?: ValueTypes["PostObjectFieldFormatEnum"] | null;
            },
            boolean
        ];
    ...
    ["ContentType"]: AliasType<{
        ...
        connectedTaxonomies?: [
            ...
            ValueTypes["ContentTypeToTaxonomyConnection"]
        ];
        contentNodes?: [
            {
                first?: number | null; /** The number of items to return before the referenced "before" cursor */
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["ContentTypeToContentNodeConnectionWhereArgs"] | null;
            },
            ValueTypes["ContentTypeToContentNodeConnection"]
        ];
    ...
    ["Taxonomy"]: AliasType<{
        connectedContentTypes?: [
            ...
            ValueTypes["TaxonomyToContentTypeConnection"]
        ];
    ...
    ["User"]: AliasType<{
        avatar?: [
            {
                ...
                rating?: ValueTypes["AvatarRatingEnum"] | null;
            },
            ValueTypes["Avatar"]
        ];
        badges?: [
            {
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["UserToBadgeConnectionWhereArgs"] | null;
            },
            ValueTypes["UserToBadgeConnection"]
        ];
        ...
        comments?: [
            {
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["UserToCommentConnectionWhereArgs"] | null;
            },
            ValueTypes["UserToCommentConnection"]
        ];
        conditionalTags?: ValueTypes["ConditionalTags"];
        ...
        enqueuedScripts?: [
            ...
            ValueTypes["UserToEnqueuedScriptConnection"]
        ];
        enqueuedStylesheets?: [
            {
                first?: number | null; /** The number of items to return before the referenced "before" cursor */
            ...
            ValueTypes["UserToEnqueuedStylesheetConnection"]
        ];
        ...
        heroes?: [
            {
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["UserToHeroConnectionWhereArgs"] | null;
            },
            ValueTypes["UserToHeroConnection"]
        ];
        ...
        mediaItems?: [
            {
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["UserToMediaItemConnectionWhereArgs"] | null;
            },
            ValueTypes["UserToMediaItemConnection"]
        ];
        ...
        pages?: [
            {
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["UserToPageConnectionWhereArgs"] | null;
            },
            ValueTypes["UserToPageConnection"]
        ];
        posts?: [
            {
                first?: number | null; /** The number of items to return before the referenced "before" cursor */
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["UserToPostConnectionWhereArgs"] | null;
            },
            ValueTypes["UserToPostConnection"]
        ];
        ...
        revisions?: [
            {
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["UserToContentRevisionUnionConnectionWhereArgs"] | null;
            },
            ValueTypes["UserToContentRevisionUnionConnection"]
        ];
        roles?: [
            {
                first?: number | null; /** The number of items to return before the referenced "before" cursor */
            ...
            ValueTypes["UserToUserRoleConnection"]
        ];
    ...
    ["Comment"]: AliasType<{
        ...
        parent?: [
            {
                where?: ValueTypes["CommentToParentCommentConnectionWhereArgs"] | null;
            },
            ValueTypes["CommentToParentCommentConnectionEdge"]
        ];
        ...
        replies?: [
            {
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["CommentToCommentConnectionWhereArgs"] | null;
            },
            ValueTypes["CommentToCommentConnection"]
        ];
    ...
    ["Hero"]: AliasType<{
        ...
        awards?: [
            ...
            ValueTypes["HeroToBadgeConnection"]
        ];
        conditionalTags?: ValueTypes["ConditionalTags"];
        /** Connection between the ContentNode type and the ContentType type */
        contentType?: ValueTypes["ContentNodeToContentTypeConnectionEdge"];
    ...
    ["MediaItem"]: AliasType<{
        ...
        ancestors?: [
            {
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["HierarchicalContentNodeToContentNodeAncestorsConnectionWhereArgs"] | null;
            },
            ValueTypes["HierarchicalContentNodeToContentNodeAncestorsConnection"]
        ];
        /** Connection between the NodeWithAuthor type and the User type */
        author?: ValueTypes["NodeWithAuthorToUserConnectionEdge"];
        /** The database identifier of the author of the node */
        ...
        children?: [
            {
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["HierarchicalContentNodeToContentNodeChildrenConnectionWhereArgs"] | null;
            },
            ValueTypes["HierarchicalContentNodeToContentNodeChildrenConnection"]
        ];
        ...
        comments?: [
            {
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["MediaItemToCommentConnectionWhereArgs"] | null;
            },
            ValueTypes["MediaItemToCommentConnection"]
        ];
        conditionalTags?: ValueTypes["ConditionalTags"];
        /** Connection between the ContentNode type and the ContentType type */
        contentType?: ValueTypes["ContentNodeToContentTypeConnectionEdge"];
        ...
        fileSize?: [
            {
                size?: ValueTypes["MediaItemSizeEnum"] | null;
            },
            boolean
        ];
        /** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
        ...
        comments?: [
            {
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["PageToCommentConnectionWhereArgs"] | null;
            },
            ValueTypes["PageToCommentConnection"]
        ];
        conditionalTags?: ValueTypes["ConditionalTags"];
        content?: [
            {
        ...
        revisions?: [
            {
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["PageToRevisionConnectionWhereArgs"] | null;
            },
            ValueTypes["PageToRevisionConnection"]
        ];
        /** The uri slug for the post. This is equivalent to the WP_Post-&gt;post_name field and the post_name column in the database for the &quot;post_objects&quot; table. */
        slug?: boolean;
        /** The current status of the object */
        ...
        categories?: [
            {
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["PostToCategoryConnectionWhereArgs"] | null;
            },
            ValueTypes["PostToCategoryConnection"]
        ];
        /** The number of comments. Even though WPGraphQL denotes this field as an integer, in WordPress this field should be saved as a numeric string for compatibility. */
        commentCount?: boolean;
        /** Whether the comments are open or closed for this particular post. */
        ...
        comments?: [
            {
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["PostToCommentConnectionWhereArgs"] | null;
            },
            ValueTypes["PostToCommentConnection"]
        ];
        conditionalTags?: ValueTypes["ConditionalTags"];
        content?: [
            {
        ...
        postFormats?: [
            {
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["PostToPostFormatConnectionWhereArgs"] | null;
            },
            ValueTypes["PostToPostFormatConnection"]
        ];
        /** The id field matches the WP_Post-&gt;ID field. */
        postId?: boolean;
        ...
        revisions?: [
            {
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["PostToRevisionConnectionWhereArgs"] | null;
            },
            ValueTypes["PostToRevisionConnection"]
        ];
        /** The uri slug for the post. This is equivalent to the WP_Post-&gt;post_name field and the post_name column in the database for the &quot;post_objects&quot; table. */
        slug?: boolean;
        /** The current status of the object */
        ...
        tags?: [
            {
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["PostToTagConnectionWhereArgs"] | null;
            },
            ValueTypes["PostToTagConnection"]
        ];
        /** The template assigned to a node of content */
        template?: ValueTypes["ContentTemplate"];
        templates?: boolean;
        terms?: [
            {
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["PostToTermNodeConnectionWhereArgs"] | null;
            },
            ValueTypes["PostToTermNodeConnection"]
        ];
        title?: [
            {
                format?: ValueTypes["PostObjectFieldFormatEnum"] | null;
    ...
    ["Category"]: AliasType<{
        ancestors?: [
            ...
            ValueTypes["CategoryToAncestorsCategoryConnection"]
        ];
        /** The id field matches the WP_Post-&gt;ID field. */
        categoryId?: boolean;
        children?: [
            {
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["CategoryToCategoryConnectionWhereArgs"] | null;
            },
            ValueTypes["CategoryToCategoryConnection"]
        ];
        conditionalTags?: ValueTypes["ConditionalTags"];
        contentNodes?: [
            {
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["CategoryToContentNodeConnectionWhereArgs"] | null;
            },
            ValueTypes["CategoryToContentNodeConnection"]
        ];
        ...
        enqueuedScripts?: [
            ...
            ValueTypes["TermNodeToEnqueuedScriptConnection"]
        ];
        enqueuedStylesheets?: [
            {
                first?: number | null; /** The number of items to return before the referenced "before" cursor */
            ...
            ValueTypes["TermNodeToEnqueuedStylesheetConnection"]
        ];
        /** The unique resource identifier path */
        id?: boolean;
        /** Whether the node is a Content Node */
        ...
        posts?: [
            {
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["CategoryToPostConnectionWhereArgs"] | null;
            },
            ValueTypes["CategoryToPostConnection"]
        ];
        ...
        contentNodes?: [
            {
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["PostFormatToContentNodeConnectionWhereArgs"] | null;
            },
            ValueTypes["PostFormatToContentNodeConnection"]
        ];
        /** The number of objects connected to the object */
        count?: boolean;
        /** The unique identifier stored in the database */
        ...
        posts?: [
            {
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["PostFormatToPostConnectionWhereArgs"] | null;
            },
            ValueTypes["PostFormatToPostConnection"]
        ];
        /** An alphanumeric identifier for the object unique to its type. */
        slug?: boolean;
        ...
        contentNodes?: [
            {
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["TagToContentNodeConnectionWhereArgs"] | null;
            },
            ValueTypes["TagToContentNodeConnection"]
        ];
        /** The number of objects connected to the object */
        count?: boolean;
        /** The unique resource identifier path */
        ...
        posts?: [
            {
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["TagToPostConnectionWhereArgs"] | null;
            },
            ValueTypes["TagToPostConnection"]
        ];
        /** An alphanumeric identifier for the object unique to its type. */
        slug?: boolean;
        /** The id field matches the WP_Post-&gt;ID field. */
    ...
    ["ContentRevisionUnion"]: AliasType<{
        ...
        menuItems?: [
            {
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["MenuToMenuItemConnectionWhereArgs"] | null;
            },
            ValueTypes["MenuToMenuItemConnection"]
        ];
        ...
        childItems?: [
            {
                ...
                after?: string | null; /** Cursor used along with the "last" argument to reference where in the dataset to get data */
                before?: string | null; /** Arguments for filtering the connection */
                where?: ValueTypes["MenuItemToMenuItemConnectionWhereArgs"] | null;
            },
            ValueTypes["MenuItemToMenuItemConnection"]
        ];
    ...
    ["RootMutation"]: AliasType<{
        createBadge?: [
            {
                input: ValueTypes["CreateBadgeInput"];
            },
            ValueTypes["CreateBadgePayload"]
        ];
        createCategory?: [
            {
                input: ValueTypes["CreateCategoryInput"];
            },
            ValueTypes["CreateCategoryPayload"]
        ];
        createComment?: [
            {
                input: ValueTypes["CreateCommentInput"];
            },
            ValueTypes["CreateCommentPayload"]
        ];
        createHero?: [
            {
                input: ValueTypes["CreateHeroInput"];
            },
            ValueTypes["CreateHeroPayload"]
        ];
        createMediaItem?: [
            {
                input: ValueTypes["CreateMediaItemInput"];
            },
            ValueTypes["CreateMediaItemPayload"]
        ];
        createMovie?: [
            {
                input: ValueTypes["CreateMovieInput"];
            },
            ValueTypes["CreateMoviePayload"]
        ];
        createPage?: [
            {
                input: ValueTypes["CreatePageInput"];
            },
            ValueTypes["CreatePagePayload"]
        ];
        createPost?: [
            {
                input: ValueTypes["CreatePostInput"];
            },
            ValueTypes["CreatePostPayload"]
        ];
        createPostFormat?: [
            {
                input: ValueTypes["CreatePostFormatInput"];
            },
            ValueTypes["CreatePostFormatPayload"]
        ];
        createTag?: [
            {
                input: ValueTypes["CreateTagInput"];
            },
            ValueTypes["CreateTagPayload"]
        ];
        createUser?: [
            {
                input: ValueTypes["CreateUserInput"];
            },
            ValueTypes["CreateUserPayload"]
        ];
        deleteBadge?: [
            {
                input: ValueTypes["DeleteBadgeInput"];
            },
            ValueTypes["DeleteBadgePayload"]
        ];
        deleteCategory?: [
            {
                input: ValueTypes["DeleteCategoryInput"];
            },
            ValueTypes["DeleteCategoryPayload"]
        ];
        deleteComment?: [
            {
                input: ValueTypes["DeleteCommentInput"];
            },
            ValueTypes["DeleteCommentPayload"]
        ];
        deleteHero?: [
            {
                input: ValueTypes["DeleteHeroInput"];
            },
            ValueTypes["DeleteHeroPayload"]
        ];
        deleteMediaItem?: [
            {
                input: ValueTypes["DeleteMediaItemInput"];
            },
            ValueTypes["DeleteMediaItemPayload"]
        ];
        deleteMovie?: [
            {
                input: ValueTypes["DeleteMovieInput"];
            },
            ValueTypes["DeleteMoviePayload"]
        ];
        deletePage?: [
            {
                input: ValueTypes["DeletePageInput"];
            },
            ValueTypes["DeletePagePayload"]
        ];
        deletePost?: [
            {
                input: ValueTypes["DeletePostInput"];
            },
            ValueTypes["DeletePostPayload"]
        ];
        deletePostFormat?: [
            {
                input: ValueTypes["DeletePostFormatInput"];
            },
            ValueTypes["DeletePostFormatPayload"]
        ];
        deleteTag?: [
            {
                input: ValueTypes["DeleteTagInput"];
            },
            ValueTypes["DeleteTagPayload"]
        ];
        deleteUser?: [
            {
                input: ValueTypes["DeleteUserInput"];
            },
            ValueTypes["DeleteUserPayload"]
        ];
        generateAuthorizationCode?: [
            {
                input: ValueTypes["GenerateAuthorizationCodeInput"];
            },
            ValueTypes["GenerateAuthorizationCodePayload"]
        ];
        increaseCount?: [
            {
                count?: number | null;
        ...
        registerUser?: [
            {
                input: ValueTypes["RegisterUserInput"];
            },
            ValueTypes["RegisterUserPayload"]
        ];
        resetUserPassword?: [
            {
                input: ValueTypes["ResetUserPasswordInput"];
            },
            ValueTypes["ResetUserPasswordPayload"]
        ];
        restoreComment?: [
            {
                input: ValueTypes["RestoreCommentInput"];
            },
            ValueTypes["RestoreCommentPayload"]
        ];
        sendPasswordResetEmail?: [
            {
                input: ValueTypes["SendPasswordResetEmailInput"];
            },
            ValueTypes["SendPasswordResetEmailPayload"]
        ];
        updateBadge?: [
            {
                input: ValueTypes["UpdateBadgeInput"];
            },
            ValueTypes["UpdateBadgePayload"]
        ];
        updateCategory?: [
            {
                input: ValueTypes["UpdateCategoryInput"];
            },
            ValueTypes["UpdateCategoryPayload"]
        ];
        updateComment?: [
            {
                input: ValueTypes["UpdateCommentInput"];
            },
            ValueTypes["UpdateCommentPayload"]
        ];
        updateHero?: [
            {
                input: ValueTypes["UpdateHeroInput"];
            },
            ValueTypes["UpdateHeroPayload"]
        ];
        updateMediaItem?: [
            {
                input: ValueTypes["UpdateMediaItemInput"];
            },
            ValueTypes["UpdateMediaItemPayload"]
        ];
        updateMovie?: [
            {
                input: ValueTypes["UpdateMovieInput"];
            },
            ValueTypes["UpdateMoviePayload"]
        ];
        updatePage?: [
            {
                input: ValueTypes["UpdatePageInput"];
            },
            ValueTypes["UpdatePagePayload"]
        ];
        updatePost?: [
            {
                input: ValueTypes["UpdatePostInput"];
            },
            ValueTypes["UpdatePostPayload"]
        ];
        updatePostFormat?: [
            {
                input: ValueTypes["UpdatePostFormatInput"];
            },
            ValueTypes["UpdatePostFormatPayload"]
        ];
        updateSettings?: [
            {
                input: ValueTypes["UpdateSettingsInput"];
            },
            ValueTypes["UpdateSettingsPayload"]
        ];
        updateTag?: [
            {
                input: ValueTypes["UpdateTagInput"];
            },
            ValueTypes["UpdateTagPayload"]
        ];
        updateUser?: [
            {
                input: ValueTypes["UpdateUserInput"];
            },
            ValueTypes["UpdateUserPayload"]
        ];
        __typename?: boolean;
    }>;
...
/** The Type of Identifier used to fetch a single resource. Default is ID. */
export declare const enum BadgeIdType {
...
/** Allowed Content Types */
export declare const enum ContentTypeEnum {
...
/** The size of the media item object. */
export declare const enum MediaItemSizeEnum {
    LARGE = "LARGE",
    MEDIUM = "MEDIUM",
...
/** Allowed Content Types of the Category taxonomy. */
export declare const enum ContentTypesOfCategoryEnum {
    POST = "POST"
}
/** Allowed Content Types of the PostFormat taxonomy. */
export declare const enum ContentTypesOfPostFormatEnum {
    POST = "POST"
}
/** Allowed Content Types of the Tag taxonomy. */
export declare const enum ContentTypesOfTagEnum {
    POST = "POST"
}
/** Allowed taxonomies */
...
/** The Type of Identifier used to fetch a single resource. Default is ID. */
export declare const enum CategoryIdType {
    DATABASE_ID = "DATABASE_ID",
    ID = "ID",
    NAME = "NAME",
    SLUG = "SLUG",
...
/** The Type of Identifier used to fetch a single resource. Default is ID. */
export declare const enum ContentNodeIdTypeEnum {
    DATABASE_ID = "DATABASE_ID",
    ID = "ID",
    URI = "URI"
}
/** The Type of Identifier used to fetch a single Content Type node. To be used along with the "id" field. Default is "ID". */
export declare const enum ContentTypeIdTypeEnum {
    ID = "ID",
    NAME = "NAME"
}
/** The Type of Identifier used to fetch a single resource. Default is ID. */
export declare const enum HeroIdType {
    DATABASE_ID = "DATABASE_ID",
    ID = "ID",
    SLUG = "SLUG",
    URI = "URI"
...
/** The Type of Identifier used to fetch a single resource. Default is ID. */
export declare const enum MediaItemIdType {
    DATABASE_ID = "DATABASE_ID",
    ID = "ID",
    SLUG = "SLUG",
...
/** The Type of Identifier used to fetch a single node. Default is "ID". To be used along with the "id" field. */
export declare const enum MenuNodeIdTypeEnum {
    DATABASE_ID = "DATABASE_ID",
    ID = "ID",
    NAME = "NAME"
}
...
/** The Type of Identifier used to fetch a single node. Default is "ID". To be used along with the "id" field. */
export declare const enum MenuItemNodeIdTypeEnum {
    DATABASE_ID = "DATABASE_ID",
    ID = "ID"
}
/** The Type of Identifier used to fetch a single resource. Default is ID. */
export declare const enum MovieIdType {
    DATABASE_ID = "DATABASE_ID",
    ID = "ID",
    SLUG = "SLUG",
    URI = "URI"
...
/** The Type of Identifier used to fetch a single resource. Default is ID. */
export declare const enum PageIdType {
    DATABASE_ID = "DATABASE_ID",
    ID = "ID",
    URI = "URI"
}
/** The Type of Identifier used to fetch a single resource. Default is ID. */
export declare const enum PostIdType {
    DATABASE_ID = "DATABASE_ID",
    ID = "ID",
    SLUG = "SLUG",
    URI = "URI"
...
/** The Type of Identifier used to fetch a single resource. Default is ID. */
export declare const enum PostFormatIdType {
    DATABASE_ID = "DATABASE_ID",
    ID = "ID",
    NAME = "NAME",
    SLUG = "SLUG",
...
/** The Type of Identifier used to fetch a single resource. Default is ID. */
export declare const enum TagIdType {
    DATABASE_ID = "DATABASE_ID",
    ID = "ID",
    NAME = "NAME",
    SLUG = "SLUG",
...
/** The Type of Identifier used to fetch a single Taxonomy node. To be used along with the "id" field. Default is "ID". */
export declare const enum TaxonomyIdTypeEnum {
    ID = "ID",
    NAME = "NAME"
}
/** The Type of Identifier used to fetch a single resource. Default is "ID". To be used along with the "id" field. */
export declare const enum TermNodeIdTypeEnum {
    DATABASE_ID = "DATABASE_ID",
    ID = "ID",
    NAME = "NAME",
    SLUG = "SLUG",
...
/** The Type of Identifier used to fetch a single User node. To be used along with the "id" field. Default is "ID". */
export declare const enum UserNodeIdTypeEnum {
    DATABASE_ID = "DATABASE_ID",
    EMAIL = "EMAIL",
    ID = "ID",
    SLUG = "SLUG",
...
/** Field to order the connection by */
export declare const enum UsersConnectionOrderbyEnum {
...
/** The status of the media item object. */
export declare const enum MediaItemStatusEnum {
    AUTO_DRAFT = "AUTO_DRAFT",
    INHERIT = "INHERIT",
    PRIVATE = "PRIVATE",
    TRASH = "TRASH"
...
export declare type GenericOperation<O> = O extends 'query' ? "RootQuery" : O extends 'mutation' ? "RootMutation" : never;
export declare const Thunder: (fn: FetchFunction) => <O extends "query" | "mutation", R extends keyof ValueTypes = GenericOperation<O>>(operation: O) => <Z extends ValueTypes[R]>(o: Z | ValueTypes[R], ops?: OperationOptions) => Promise<InputType<GraphQLTypes[R], Z>>;
export declare const Chain: (...options: chainOptions) => <O extends "query" | "mutation", R extends keyof ValueTypes = GenericOperation<O>>(operation: O) => <Z extends ValueTypes[R]>(o: Z | ValueTypes[R], ops?: OperationOptions) => Promise<InputType<GraphQLTypes[R], Z>>;
export declare const SubscriptionThunder: (fn: SubscriptionFunction) => <O extends "query" | "mutation", R extends keyof ValueTypes = GenericOperation<O>>(operation: O) => <Z extends ValueTypes[R]>(o: Z | ValueTypes[R], ops?: OperationOptions) => SubscriptionToGraphQL<Z, GraphQLTypes[R]>;
export declare const Subscription: (...options: chainOptions) => <O extends "query" | "mutation", R extends keyof ValueTypes = GenericOperation<O>>(operation: O) => <Z extends ValueTypes[R]>(o: Z | ValueTypes[R], ops?: OperationOptions) => SubscriptionToGraphQL<Z, GraphQLTypes[R]>;
export declare const Zeus: <Z extends ValueTypes[R], O extends "query" | "mutation", R extends keyof ValueTypes = GenericOperation<O>>(operation: O, o: Z | ValueTypes[R], operationName?: string) => string;
export declare const Selector: <T extends keyof ValueTypes>(key: T) => SelectionFunction<ValueTypes[T]>;
export declare const Gql: <O extends "query" | "mutation", R extends keyof ValueTypes = GenericOperation<O>>(operation: O) => <Z extends ValueTypes[R]>(o: Z | ValueTypes[R], ops?: OperationOptions) => Promise<InputType<GraphQLTypes[R], Z>>;
export {};
